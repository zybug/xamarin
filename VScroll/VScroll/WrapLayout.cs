...
namespace VScroll
{
    public class WrapLayout : Layout<View>
    {
        ...
        public bool OneColumns
        {
            get { return (bool)GetValue(OneColumnsProperty); }
            set { SetValue(OneColumnsProperty , value); }
        }
        public static BindableProperty OneColumnsProperty =
            BindableProperty.Create(
                nameof(OneColumns),
                typeof(bool),
                typeof(WrapLayout),
        ...
        protected override SizeRequest OnMeasure(double widthConstraint, double heightConstraint)
        {
            ...
            if (OneColumns)
                return OneColumnMeasureAndLayout(internalWidth, internalHeight);
        ...
        protected override void LayoutChildren(double x, double y, double width, double height)
        {
            if (OneColumns)
            {
                OneColumnMeasureAndLayout(width, height, true, x, y);
            }
            else
            if (UniformColumns > 0)
            {
        ...
        private SizeRequest OneColumnMeasureAndLayout(double widthConstraint, double heightConstraint, bool doLayout = false, double x = 0, double y = 0)
        {
